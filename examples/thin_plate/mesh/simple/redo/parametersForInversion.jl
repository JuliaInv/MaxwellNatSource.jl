...
meshfile = "../octree_mesh.txt" # "meshInv.txt"
#truemodelfile = "mesh/model_plate.con"


# of cells in base mesh
#n     = vec([ 4096  4096  4096 ])
n     = vec([ 131072 65536 65536 ])
# corner of the mesh
#x0    = vec([ -51250.0  -51200.0  -51200.0 ])
x0    = vec([ -3.27680000E+05 -3.27680000E+05  -430080.0 ])
# total mesh lengths  
meshL = vec([ 655360.  655360.  655360. ])
