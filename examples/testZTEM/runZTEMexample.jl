...
outputFieldZTEMdata("data33.txt", trx[itx], DD[:,1])
outputFieldZTEMdata("data44.txt", trx[itx], DD[:,2])
...
outputFieldZTEMdata("data55.txt", trx[itx], DD[:,1])
outputFieldZTEMdata("data66.txt", trx[itx], DD[:,2])
